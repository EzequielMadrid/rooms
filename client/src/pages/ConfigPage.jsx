...
const PREVIEW_MESSAGES = [
  {
    id: 1,
    content: "Peter! What r you doing? Chameleon's attacking Queens.",
    isSent: false,
    time: "2:45 PM",
  },
  {
    id: 2,
    content:
      "Miles, I'm not in New York right now, take care of it yourself. And stop calling me Peter!",
    isSent: true,
    time: "3:13 PM",
  },
];
    ...
    <div className="min-h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          <h2 className="text-lg font-semibold tracking-widest">Theme</h2>
          <p className="text-sm text-base-content/70 tracking-wider">
            Choose your favorite styles!
          </p>
        </div>
        <section className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
          {THEMES.map((t) => (
            <button
              key={t}
              className={`
          ...
          <div className="p-4 bg-base-200">
            <div className="max-w-lg mx-auto">
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                <header className="px-4 py-3 border-b border-base-300 bg-base-100">
