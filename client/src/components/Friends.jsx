            ...
            >
              <div className="relative mx-auto lg:mx-0">
                <img
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setEnlargedImage(user.profilePic || "/avatar.gif");
                  }}
                  className="size-12 object-cover rounded-full cursor-pointer transition-transform duration-300 hover:scale-105"
                />
